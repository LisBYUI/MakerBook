...
namespace MakerBook.Controllers
{
    public class ContactController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,PhoneNumber")] ContactModel contactModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,PhoneNumber")] ContactModel contactModel)
        {
